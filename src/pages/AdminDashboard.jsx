      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <button className="px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">Upload</button>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <button className="px-4 py-2 bg-green-600 rounded-lg hover:bg-green-700 transition-colors">Manage</button>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <button className="px-4 py-2 bg-purple-600 rounded-lg hover:bg-purple-700 transition-colors">Manage</button>
          </div>
        </div>
